...
const char CreatureFamilyfmt[]="nxxxxxxisxxxxxxxxx";
...
const char ItemSetEntryfmt[]="dxxxxxxxxxxxxxxxxxxxxxxxxxxiiiiiiiiiiiiiiiiii";
const char LockEntryfmt[]="nxxxxxxxxxxxxxxxxiixxxxxxxxxxxxxx";
...
const char SpellEntryfmt[]="niixiiiiixiixiiixiiiiiiiiiiiiiiiiiiiifiiiiiiiiiiiiiiiiiiiiiixiiiiiiiiiffffffiiixxxiiiiiiiiiiiiiiifffiiiiiiiiiiiifffixiiissssssssissssssssixxxxxxxxxxxxxxxxxxiiixiiixxxxxxxxxx";
