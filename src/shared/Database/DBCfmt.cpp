...
const char ChatChannelsEntryfmt[]="iixssssssssssssssssxxxxxxxxxxxxxxxxxx";  // data not sorted (more compact store)
...
const char FactionEntryfmt[]="niiiiixxxxiiiixxxxissssssssssssssssxxxxxxxxxxxxxxxxxx";
...
const char MapEntryfmt[]="nxissssssssssssssssxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxixxxxx";
const char SkillLinefmt[]="nixssssssssxxxxxxxxxssssssssxxxxxxxxxi";
const char SkillLineAbilityfmt[]="iinxxxxiixiixxi";
const char SpellCastTimefmt[]="nixx";
const char SpellDurationfmt[]="niii";
const char SpellEntryfmt[]="niixiiiiiiixixiiiiixxiiiiiiiiiiiiiiiiiiifiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiffffffiiixxxiiiiiiiiiiiiiiifffiiiiiiiiiiiifffixiiissssssssssssssssxssssssssssssssssxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxiiiiiiiiixxfffxxxiii";
...
const char TalentTabEntryfmt[]="nxxxxxxxxxxxxxxxxxxxixx";
