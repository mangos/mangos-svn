...
ChatCommand * ChatHandler::getCommandTable()
{
    ...
    static ChatCommand commandTable[] =
    {
        ...
        { "flaginfo",    3, &ChatHandler::HandleFlagInfoCommand,         "",   NULL },
        { "spellattr",   3, &ChatHandler::HandleSpellAttrCommand,        "",   NULL },
        { "findspell",   3, &ChatHandler::HandleFindSpellCommand,        "",   NULL },
