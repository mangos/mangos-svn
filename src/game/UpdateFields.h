...
enum EUnitFields
{
	...
	PLAYER_VISIBLE_ITEM_1_CREATOR             = 0x48 + UNIT_END, //260
	PLAYER_VISIBLE_ITEM_1_0                   = 0x4A + UNIT_END,
	PLAYER_VISIBLE_ITEM_1_PROPERTIES          = 0x52 + UNIT_END,
	PLAYER_VISIBLE_ITEM_1_PAD                 = 0x53 + UNIT_END, //271
	
	PLAYER_VISIBLE_ITEM_2_CREATOR             = 0x54 + UNIT_END, //272
	PLAYER_VISIBLE_ITEM_2_0                   = 0x56 + UNIT_END,
	PLAYER_VISIBLE_ITEM_2_PROPERTIES          = 0x5E + UNIT_END,
	PLAYER_VISIBLE_ITEM_2_PAD                 = 0x5F + UNIT_END, //283

	PLAYER_VISIBLE_ITEM_3_CREATOR             = 0x60 + UNIT_END, //284
	PLAYER_VISIBLE_ITEM_3_0                   = 0x62 + UNIT_END,
	PLAYER_VISIBLE_ITEM_3_PROPERTIES          = 0x6A + UNIT_END,
	PLAYER_VISIBLE_ITEM_3_PAD                 = 0x6B + UNIT_END, //295
	
	PLAYER_VISIBLE_ITEM_4_CREATOR             = 0x6C + UNIT_END, //296
	PLAYER_VISIBLE_ITEM_4_0                   = 0x6E + UNIT_END,
	PLAYER_VISIBLE_ITEM_4_PROPERTIES          = 0x76 + UNIT_END,
	PLAYER_VISIBLE_ITEM_4_PAD                 = 0x77 + UNIT_END, //307
	
	PLAYER_VISIBLE_ITEM_5_CREATOR             = 0x78 + UNIT_END,//308
	PLAYER_VISIBLE_ITEM_5_0                   = 0x7A + UNIT_END,
	PLAYER_VISIBLE_ITEM_5_PROPERTIES          = 0x82 + UNIT_END,
	PLAYER_VISIBLE_ITEM_5_PAD                 = 0x83 + UNIT_END,//319
	
	PLAYER_VISIBLE_ITEM_6_CREATOR             = 0x84 + UNIT_END,//320
	PLAYER_VISIBLE_ITEM_6_0                   = 0x86 + UNIT_END,
	PLAYER_VISIBLE_ITEM_6_PROPERTIES          = 0x8E + UNIT_END,
	PLAYER_VISIBLE_ITEM_6_PAD                 = 0x8F + UNIT_END,//331
	
	PLAYER_VISIBLE_ITEM_7_CREATOR             = 0x90 + UNIT_END,//332
	PLAYER_VISIBLE_ITEM_7_0                   = 0x92 + UNIT_END,
	PLAYER_VISIBLE_ITEM_7_PROPERTIES          = 0x9A + UNIT_END,
	PLAYER_VISIBLE_ITEM_7_PAD                 = 0x9B + UNIT_END,//343
	
	PLAYER_VISIBLE_ITEM_8_CREATOR             = 0x9C + UNIT_END,//344
	PLAYER_VISIBLE_ITEM_8_0                   = 0x9E + UNIT_END,
	PLAYER_VISIBLE_ITEM_8_PROPERTIES          = 0xA6 + UNIT_END,
	PLAYER_VISIBLE_ITEM_8_PAD                 = 0xA7 + UNIT_END,//355
	
	PLAYER_VISIBLE_ITEM_9_CREATOR             = 0xA8 + UNIT_END,//356
	PLAYER_VISIBLE_ITEM_9_0                   = 0xAA + UNIT_END,
	PLAYER_VISIBLE_ITEM_9_PROPERTIES          = 0xB2 + UNIT_END,
	PLAYER_VISIBLE_ITEM_9_PAD                 = 0xB3 + UNIT_END,//367
	
	PLAYER_VISIBLE_ITEM_10_CREATOR            = 0xB4 + UNIT_END,//368
	PLAYER_VISIBLE_ITEM_10_0                  = 0xB6 + UNIT_END,
	PLAYER_VISIBLE_ITEM_10_PROPERTIES         = 0xBE + UNIT_END,
	PLAYER_VISIBLE_ITEM_10_PAD                = 0xBF + UNIT_END,//379
	
	PLAYER_VISIBLE_ITEM_11_CREATOR            = 0xC0 + UNIT_END,//380
	PLAYER_VISIBLE_ITEM_11_0                  = 0xC2 + UNIT_END,
	PLAYER_VISIBLE_ITEM_11_PROPERTIES         = 0xCA + UNIT_END,
	PLAYER_VISIBLE_ITEM_11_PAD                = 0xCB + UNIT_END,//391
	
	PLAYER_VISIBLE_ITEM_12_CREATOR            = 0xCC + UNIT_END,//392
	PLAYER_VISIBLE_ITEM_12_0                  = 0xCE + UNIT_END,
	PLAYER_VISIBLE_ITEM_12_PROPERTIES         = 0xD6 + UNIT_END,
	PLAYER_VISIBLE_ITEM_12_PAD                = 0xD7 + UNIT_END,//403
	
	PLAYER_VISIBLE_ITEM_13_CREATOR            = 0xD8 + UNIT_END,//404
	PLAYER_VISIBLE_ITEM_13_0                  = 0xDA + UNIT_END,
	PLAYER_VISIBLE_ITEM_13_PROPERTIES         = 0xE2 + UNIT_END,
	PLAYER_VISIBLE_ITEM_13_PAD                = 0xE3 + UNIT_END,//415
	
	PLAYER_VISIBLE_ITEM_14_CREATOR            = 0xE4 + UNIT_END,//416
	PLAYER_VISIBLE_ITEM_14_0                  = 0xE6 + UNIT_END,
	PLAYER_VISIBLE_ITEM_14_PROPERTIES         = 0xEE + UNIT_END,
	PLAYER_VISIBLE_ITEM_14_PAD                = 0xEF + UNIT_END,//427
	
	PLAYER_VISIBLE_ITEM_15_CREATOR            = 0xF0 + UNIT_END,//428
	PLAYER_VISIBLE_ITEM_15_0                  = 0xF2 + UNIT_END,
	PLAYER_VISIBLE_ITEM_15_PROPERTIES         = 0xFA + UNIT_END,
	PLAYER_VISIBLE_ITEM_15_PAD                = 0xFB + UNIT_END,//439
	
	PLAYER_VISIBLE_ITEM_16_CREATOR            = 0xFC + UNIT_END,//440
	PLAYER_VISIBLE_ITEM_16_0                  = 0xFE + UNIT_END,
	PLAYER_VISIBLE_ITEM_16_PROPERTIES         = 0x106 + UNIT_END,
	PLAYER_VISIBLE_ITEM_16_PAD                = 0x107 + UNIT_END,//451
	
	PLAYER_VISIBLE_ITEM_17_CREATOR            = 0x108 + UNIT_END,//452
	PLAYER_VISIBLE_ITEM_17_0                  = 0x10A + UNIT_END,
	PLAYER_VISIBLE_ITEM_17_PROPERTIES         = 0x112 + UNIT_END,
	PLAYER_VISIBLE_ITEM_17_PAD                = 0x113 + UNIT_END,//463
    
	PLAYER_VISIBLE_ITEM_18_CREATOR            = 0x114 + UNIT_END,//464
	//466 ranged
	PLAYER_VISIBLE_ITEM_18_0                  = 0x116 + UNIT_END,
	PLAYER_VISIBLE_ITEM_18_PROPERTIES         = 0x11E + UNIT_END,
	PLAYER_VISIBLE_ITEM_18_PAD                = 0x11F + UNIT_END,//475
	
	PLAYER_VISIBLE_ITEM_19_CREATOR            = 0x120 + UNIT_END,//476
	PLAYER_VISIBLE_ITEM_19_0                  = 0x122 + UNIT_END,
	PLAYER_VISIBLE_ITEM_19_PROPERTIES         = 0x12A + UNIT_END,
	PLAYER_VISIBLE_ITEM_19_PAD                = 0x12B + UNIT_END,//487
	...
	PLAYER_FIELD_MOD_DAMAGE_DONE_POS          = 0x3B7 + PLAYER_SELECTION, //float 1.0
	PLAYER_FIELD_MOD_DAMAGE_DONE_NEG          = 0x3BE + PLAYER_SELECTION, //float 1.0
	PLAYER_FIELD_MOD_DAMAGE_DONE_PCT          = 0x3C5 + PLAYER_SELECTION, //float 1.0
