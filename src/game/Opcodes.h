...
enum OpCodes
{
    ...
    CMSG_GM_UNTEACH                                 = 741-2,
    SMSG_HARDWARE_SURVEY_REQUEST                    = 742-2,
    CMSG_HARDWARE_SURVEY_RESULTS                    = 743-2,
    SMSG_WARDEN_DATA                                = 744-2,
    CMSG_WARDEN_DATA                                = 745-2,
    SMSG_GROUP_JOINED_BATTLEGROUND                  = 746-2,
    MSG_BATTLEGROUND_PLAYER_POSITIONS               = 747-2,

                                                            //strange!!
    //MSG_BINDPOINT_CONFIRM = SMSG_BINDER_CONFIRM,

    //TODO Check double check if the -2 is correct
    CMSG_PET_STOP_ATTACK                            = 748-2,
    SMSG_BINDER_CONFIRM                             = 749-2,
    SMSG_BATTLEGROUND_PLAYER_JOINED                 = 750-2,
    SMSG_BATTLEGROUND_PLAYER_LEFT                   = 751-2,
    CMSG_BATTLEMASTER_JOIN                          = 752-2,
