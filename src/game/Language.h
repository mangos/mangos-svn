...
#define LANG_COMMAND_NOTCHANGEPASSWORD   "Your password can't be longer than 16 characters (client limit), Password isn't changed!"
...
#define LANG_CANNOT_INST_INST            "You can not go to players or summon players from instance to instance."
...
#define LANG_YOURS_TAXIS_REMOVED         "%s has removed access to all taxi nodes (only visited still accessable)."
...
#define LANG_COMMAND_GRAVEYARD_NOTEAM    "invalid team, please fix DB"
