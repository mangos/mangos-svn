...
static void grid_compression(const char *src_tbl, const char *dest_tbl)
{
    ...
    sDatabase.PExecute("INSERT INTO `%s` (`guid`,`map`,`position_x`,`position_y`,`cell_position_x`,`cell_position_y` ) SELECT `guid`,`map`,ROUND(((`position_x`-%f)/%f) + %u.00001),ROUND(((`position_y`-%f)/%f) + %u.00001),ROUND(((`position_x`-%f)/%f) + %u.00001),ROUND(((`position_y`-%f)/%f) + %u.00001)  FROM `%s`", dest_tbl, CENTER_GRID_OFFSET, SIZE_OF_GRIDS, CENTER_GRID_ID, CENTER_GRID_OFFSET,SIZE_OF_GRIDS, CENTER_GRID_ID, CENTER_GRID_CELL_OFFSET,SIZE_OF_GRID_CELL, CENTER_GRID_CELL_ID, CENTER_GRID_CELL_OFFSET, SIZE_OF_GRID_CELL, CENTER_GRID_CELL_ID, src_tbl);
