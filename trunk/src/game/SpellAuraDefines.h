...
enum MOD_TYPES
{
    ...
    SPELL_AURA_MOD_SHIELD_BLOCK_PCT = 150,
    ...
    SPELL_AURA_MOD_SHIELD_BLOCK = 158,
    ...
    SPELL_AURA_MOD_PARTY_SPEED = 171, // unused
    SPELL_AURA_MOD_PARTY_SPEED_MOUNTED = 172,
    SPELL_AURA_ALLOW_CHAMPION_SPELLS = 173,
    SPELL_AURA_MOD_SPELL_DAMAGE_OF_SPIRIT  = 174,
    SPELL_AURA_MOD_SPELL_HEALING_OF_SPIRIT = 175,
    SPELL_AURA_SPIRIT_OF_REDEMPTION = 176,
    SPELL_AURA_AOE_CHARM = 177,
    SPELL_AURA_MOD_DEBUFF_RESISTANCE = 178,
    SPELL_AURA_MOD_ATTACKER_SPELL_CRIT_CHANCE = 179,
    SPELL_AURA_MOD_SPELL_DAMAGE_VS_UNDEAD = 180,
    SPELL_AURA_181 = 181,
    SPELL_AURA_MOD_ARMOR_OF_INTELLECT = 182,
    ...
    SPELL_AURA_MOD_SPELL_DAMAGE_OF_INTELLECT  = 194,
    SPELL_AURA_MOD_SPELL_HEALING_OF_INTELLECT = 195,
    SPELL_AURA_196 = 196, // unused
    SPELL_AURA_MOD_ATTACKER_SPELL_CRIT_CHANCE_PCT = 197,
    SPELL_AURA_MOD_ALL_WEAPON_SKILLS = 198,
    SPELL_AURA_MOD_INCREASES_SPELL_PCT_TO_HIT = 199,
    SPELL_AURA_200 = 200,
    SPELL_AURA_201 = 201,
    SPELL_AURA_CANNOT_BE_DODGED = 202,
    ...
    SPELL_AURA_208 = 208,
    SPELL_AURA_209 = 209, // unused
    SPELL_AURA_210 = 210, // unused
    SPELL_AURA_211 = 211, // unused
    SPELL_AURA_MOD_RANGED_ATTACK_POWER__OF_INTELLECT = 212,
    SPELL_AURA_MOD_RANGE_FROM_DAMAGE_DEALT = 213,
    SPELL_AURA_214 = 214,
    SPELL_AURA_215 = 215,
    SPELL_AURA_HASTE_SPELLS = 216,
    SPELL_AURA_217 = 217,
    SPELL_AURA_218 = 218,
    SPELL_AURA_MOD_MANA_REGEN = 219,
    SPELL_AURA_220 = 220,
