...
{
    AURA_INTERRUPT_FLAG_UNK1                = 0x00000001,   // 0
    AURA_INTERRUPT_FLAG_DAMAGE              = 0x00000002,   // 1    removed by any damage
    AURA_INTERRUPT_FLAG_UNK2                = 0x00000004,   // 2
    AURA_INTERRUPT_FLAG_MOVE                = 0x00000008,   // 3    removed by any movement
    AURA_INTERRUPT_FLAG_TURNING             = 0x00000010,   // 4    removed by any turning
    AURA_INTERRUPT_FLAG_UNK3                = 0x00000020,   // 5
    AURA_INTERRUPT_FLAG_NOT_MOUNTED         = 0x00000040,   // 6    removed by unmounting
    AURA_INTERRUPT_FLAG_NOT_ABOVEWATER      = 0x00000080,   // 7    removed by entering water
    AURA_INTERRUPT_FLAG_NOT_UNDERWATER      = 0x00000100,   // 8    removed by leaving water
    AURA_INTERRUPT_FLAG_NOT_SHEATHED        = 0x00000200,   // 9    removed by unsheathing
    AURA_INTERRUPT_FLAG_UNK4                = 0x00000400,   // 10
    AURA_INTERRUPT_FLAG_UNK5                = 0x00000800,   // 11
    AURA_INTERRUPT_FLAG_UNK6                = 0x00001000,   // 12
    AURA_INTERRUPT_FLAG_UNK7                = 0x00002000,   // 13
    AURA_INTERRUPT_FLAG_UNK8                = 0x00004000,   // 14
...
class MANGOS_DLL_SPEC Unit : public WorldObject
{
    public:
        ...
        void DealDamage(Unit *pVictim, uint32 damage, CleanDamage const* cleanDamage, DamageEffectType damagetype, SpellSchools damageSchool, SpellEntry const *spellProto, bool durabilityLoss);
        ...
        MeleeHitOutcome RollMeleeOutcomeAgainst (const Unit *pVictim, WeaponAttackType attType, int32 crit_chance, int32 miss_chance, int32 hit_chance, int32 dodge_chance, int32 parry_chance, int32 block_chance, bool SpellCasted ) const;
        ...
        void PeriodicAuraLog(Unit *pVictim, SpellEntry const *spellProto, Modifier *mod, uint8 effect_idx, uint64 const& itemGuid);
