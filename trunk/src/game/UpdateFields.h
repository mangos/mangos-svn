...
enum EUnitFields
{
    ...
    UNIT_FIELD_STAT0                          = 0x90 + OBJECT_END,
    UNIT_FIELD_STR                            = UNIT_FIELD_STAT0,
    UNIT_FIELD_STAT1                          = 0x91 + OBJECT_END,
    UNIT_FIELD_AGILITY                        = UNIT_FIELD_STAT1,
    UNIT_FIELD_STAT2                          = 0x92 + OBJECT_END,
    UNIT_FIELD_STAMINA                        = UNIT_FIELD_STAT2,
    UNIT_FIELD_STAT3                          = 0x93 + OBJECT_END,
    UNIT_FIELD_IQ                             = UNIT_FIELD_STAT3,
    UNIT_FIELD_STAT4                          = 0x94 + OBJECT_END,
    ...
    PLAYER_CHARACTER_POINTS1                  = 0x354 + PLAYER_SELECTION,
    PLAYER_CHARACTER_POINTS2                  = 0x355 + PLAYER_SELECTION,
    PLAYER_TRACK_CREATURES                    = 0x356 + PLAYER_SELECTION,
    PLAYER_TRACK_RESOURCES                    = 0x357 + PLAYER_SELECTION,
    PLAYER_BLOCK_PERCENTAGE                   = 0x358 + PLAYER_SELECTION,
    PLAYER_DODGE_PERCENTAGE                   = 0x359 + PLAYER_SELECTION,
    PLAYER_PARRY_PERCENTAGE                   = 0x35A + PLAYER_SELECTION,
    PLAYER_CRIT_PERCENTAGE                    = 0x35B + PLAYER_SELECTION,
    PLAYER_RANGED_CRIT_PERCENTAGE             = 0x35C + PLAYER_SELECTION,
    ...
    PLAYER_FIELD_POSSTAT3                     = 0x3A2 + PLAYER_SELECTION,
    PLAYER_FIELD_POSSTAT4                     = 0x3A3 + PLAYER_SELECTION,
    PLAYER_FIELD_NEGSTAT0                     = 0x3A4 + PLAYER_SELECTION,
    PLAYER_FIELD_NEGSTAT1                     = 0x3A5 + PLAYER_SELECTION,
    ...
    PLAYER_FIELD_MOD_DAMAGE_DONE_POS          = 0x3B7 + PLAYER_SELECTION,
                                                            //float 1.0
    PLAYER_FIELD_MOD_DAMAGE_DONE_NEG          = 0x3BE + PLAYER_SELECTION,
                                                            //float 1.0
    PLAYER_FIELD_MOD_DAMAGE_DONE_PCT          = 0x3C5 + PLAYER_SELECTION,
    PLAYER_FIELD_BYTES                        = 0x3CC + PLAYER_SELECTION,
    PLAYER_AMMO_ID                            = 0x3CD + PLAYER_SELECTION,
    PLAYER_SELF_RES_SPELL                     = 0x3CE + PLAYER_SELECTION,
    PLAYER_FIELD_PVP_MEDALS                   = 0x3CF + PLAYER_SELECTION,
    PLAYER_FIELD_BUYBACK_PRICE_1              = 0x3D0 + PLAYER_SELECTION,
    PLAYER_FIELD_BUYBACK_TIMESTAMP_1          = 0x3DC + PLAYER_SELECTION,
    PLAYER_FIELD_SESSION_KILLS                = 0x3E8 + PLAYER_SELECTION,
    PLAYER_FIELD_YESTERDAY_KILLS              = 0x3E9 + PLAYER_SELECTION,
    PLAYER_FIELD_LAST_WEEK_KILLS              = 0x3EA + PLAYER_SELECTION,
    PLAYER_FIELD_THIS_WEEK_KILLS              = 0x3EB + PLAYER_SELECTION,
    PLAYER_FIELD_THIS_WEEK_CONTRIBUTION       = 0x3EC + PLAYER_SELECTION,
    PLAYER_FIELD_LIFETIME_HONORABLE_KILLS     = 0x3ED + PLAYER_SELECTION,
    PLAYER_FIELD_LIFETIME_DISHONORABLE_KILLS  = 0x3EE + PLAYER_SELECTION,
    PLAYER_FIELD_YESTERDAY_CONTRIBUTION       = 0x3EF + PLAYER_SELECTION,
    PLAYER_FIELD_LAST_WEEK_CONTRIBUTION       = 0x3F0 + PLAYER_SELECTION,
    PLAYER_FIELD_LAST_WEEK_RANK               = 0x3F1 + PLAYER_SELECTION,
    PLAYER_FIELD_BYTES2                       = 0x3F2 + PLAYER_SELECTION,
    PLAYER_FIELD_WATCHED_FACTION_INDEX        = 0x3F3 + PLAYER_SELECTION,
    PLAYER_END                                = 0x3F4 + PLAYER_SELECTION,
};
