...
enum ResponseCodes
{
    ...
    CHAR_DELETE_FAILED_GUILD_LEADER        = 0x3D,

    CHAR_LOGIN_IN_PROGRESS                 = 0x3E,
    CHAR_LOGIN_SUCCESS                     = 0x3F,
    CHAR_LOGIN_NO_WORLD                    = 0x40,
    CHAR_LOGIN_DUPLICATE_CHARACTER         = 0x41,
    CHAR_LOGIN_NO_INSTANCES                = 0x42,
    CHAR_LOGIN_FAILED                      = 0x43,
    CHAR_LOGIN_DISABLED                    = 0x44,
    CHAR_LOGIN_NO_CHARACTER                = 0x45,
    CHAR_LOGIN_LOCKED_FOR_TRANSFER         = 0x46,
    CHAR_LOGIN_LOCKED_BY_BILLING           = 0x47,

    CHAR_NAME_NO_NAME                      = 0x48,
    CHAR_NAME_TOO_SHORT                    = 0x49,
    CHAR_NAME_TOO_LONG                     = 0x4A,
    CHAR_NAME_INVALID_CHARACTER            = 0x4B,
    CHAR_NAME_MIXED_LANGUAGES              = 0x4C,
    CHAR_NAME_PROFANE                      = 0x4D,
    CHAR_NAME_RESERVED                     = 0x4E,
    CHAR_NAME_INVALID_APOSTROPHE           = 0x4F,
    CHAR_NAME_MULTIPLE_APOSTROPHES         = 0x50,
    CHAR_NAME_THREE_CONSECUTIVE            = 0x51,
    CHAR_NAME_INVALID_SPACE                = 0x53,
    CHAR_NAME_CONSECUTIVE_SPACES           = 0x54,
