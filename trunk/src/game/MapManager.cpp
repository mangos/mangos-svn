...
static void grid_compression(const char *src_tbl, const char *dest_tbl)
{
    ...
    sDatabase.PExecute("INSERT INTO `%s` (`guid`,`map`,`position_x`,`position_y`,`cell_position_x`,`cell_position_y` ) SELECT `guid`,`map`,((`position_x`-%f)/%f) + %d,((`position_y`-%f)/%f) + %d,((`position_x`-%f)/%f) + %d,((`position_y`-%f)/%f) + %d  FROM `%s`;", dest_tbl, CENTER_GRID_OFFSET, SIZE_OF_GRIDS, CENTER_GRID_ID, CENTER_GRID_OFFSET,SIZE_OF_GRIDS, CENTER_GRID_ID, CENTER_GRID_CELL_OFFSET,SIZE_OF_GRID_CELL, CENTER_GRID_CELL_ID, CENTER_GRID_CELL_OFFSET, SIZE_OF_GRID_CELL, CENTER_GRID_CELL_ID, src_tbl);
