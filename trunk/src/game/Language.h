...
#define LANG_YOU_GIVE_TAXIS              "%s has all taxi nodes now."
#define LANG_YOU_REMOVE_TAXIS            "%s has no more taxi nodes now."
#define LANG_YOURS_TAXIS_ADDED           "%s has given you all taxi nodes."
#define LANG_YOURS_TAXIS_REMOVED         "%s has deleted all your taxi nodes."

#define LANG_YOU_CHANGE_ASPEED           "You set all speeds to %2.2f of %s."
#define LANG_YOURS_ASPEED_CHANGED        "%s set all your speeds to %2.2f."
#define LANG_YOU_CHANGE_SPEED            "You set the speed to %2.2f of %s."
#define LANG_YOURS_SPEED_CHANGED         "%s set your speed to %2.2f."
#define LANG_YOU_CHANGE_SWIM_SPEED       "You set the swim speed to %2.2f of %s."
#define LANG_YOURS_SWIM_SPEED_CHANGED    "%s set your swim speed to %2.2f."
#define LANG_YOU_CHANGE_BACK_SPEED       "You set the backwards run speed to %2.2f of %s."
#define LANG_YOURS_BACK_SPEED_CHANGED    "%s set your backwards run speed to %2.2f."
