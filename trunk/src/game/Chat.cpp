...
ChatCommand * ChatHandler::getCommandTable()
{
    ...
    static ChatCommand modifyCommandTable[] =
    {
        ...
        { "fly",         1, &ChatHandler::HandleModifyFlyCommand,        "",   NULL },
        ...
        { "titles",      1, &ChatHandler::HandleModifyKnownTitlesCommand, "",  NULL },
    ...
    static ChatCommand commandTable[] =
    {
        ...
        { "addvendoritem",2,&ChatHandler::HandleAddVendorItemCommand,    "",   NULL },
        { "delvendoritem",2,&ChatHandler::HandleDelVendorItemCommand,    "",   NULL },
        ...
        { "ban",         3, &ChatHandler::HandleBanCommand,                 "",   NULL },
        { "unban",         3, &ChatHandler::HandleUnBanCommand,            "",   NULL },
        { "baninfo",     3, &ChatHandler::HandleBanInfoCommand,             "",   NULL    },
        { "banlist",     3, &ChatHandler::HandleBanListCommand,             "",   NULL },
        ...
        { "say",         1, &ChatHandler::HandleSayCommand,              "",   NULL },
        { "yell",        1, &ChatHandler::HandleYellCommand,             "",   NULL },
        { "emote2",       1, &ChatHandler::HandleEmote2Command,            "",   NULL },
        { "whisper2",     1, &ChatHandler::HandleWhisperCommand,          "",   NULL },
        ...
        { "listcreature",3, &ChatHandler::HandleListCreatureCommand,     "",   NULL },
        ...
        { "lookupobject",3, &ChatHandler::HandleLookupObjectCommand,     "",   NULL },
        { "money",       1, &ChatHandler::HandleModifyMoneyCommand,      "",   NULL },
        { "titles",      1, &ChatHandler::HandleModifyKnownTitlesCommand, "",   NULL },
        { "speed",       1, &ChatHandler::HandleModifySpeedCommand,      "",   NULL },
        ...
        { "buyerr",      3, &ChatHandler::HandleBuyErrorCommand,         "",   NULL },
        { "uws",         3, &ChatHandler::HandleUpdateWorldStateCommand, "",   NULL },
