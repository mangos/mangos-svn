...
namespace MaNGOS
{
    ...
    template<> inline void DynamicObjectUpdater::Visit<Creature>(std::map<OBJECT_HANDLE, Player *> &);
    template<> inline void DynamicObjectUpdater::Visit<Player>(std::map<OBJECT_HANDLE, Creature *> &);
