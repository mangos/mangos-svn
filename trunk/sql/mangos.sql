...
CREATE TABLE `quests` (
  ...
  `ReqQuests1` int(10) unsigned NOT NULL default '0',
  `ReqQuests2` int(10) unsigned NOT NULL default '0',
  `ReqQuests3` int(10) unsigned NOT NULL default '0',
  `ReqQuests4` int(10) unsigned NOT NULL default '0',
  `ReqQuests5` int(10) unsigned NOT NULL default '0',
  `ReqQuests6` int(10) unsigned NOT NULL default '0',
  `ReqQuests7` int(10) unsigned NOT NULL default '0',
  `ReqQuests8` int(10) unsigned NOT NULL default '0',
  `ReqQuests9` int(10) unsigned NOT NULL default '0',
  `ReqQuests10` int(10) unsigned NOT NULL default '0',
