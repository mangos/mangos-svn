...
enum EItemFields
{
    ...
    */
                                                            // Size: 33 = (temp+perm+sockets*3+bonus+temp2*2+property*3)*3
    ITEM_FIELD_ENCHANTMENT                     = OBJECT_END + 0x10,
                                                            // Size:1
    ITEM_FIELD_SUFFIX_FACTOR                   = OBJECT_END + 0x31,
                                                            // Size:1
    ITEM_FIELD_RANDOM_PROPERTIES_ID            = OBJECT_END + 0x32,
                                                            // Size:1
    ITEM_FIELD_ITEM_TEXT_ID                    = OBJECT_END + 0x33,
                                                            // Size:1
    ITEM_FIELD_DURABILITY                      = OBJECT_END + 0x34,
                                                            // Size:1
    ITEM_FIELD_MAXDURABILITY                   = OBJECT_END + 0x35,
...
enum EUnitFields
{
    ...
    UNIT_FIELD_AURA_LAST                       = 0x61 + OBJECT_END,
                                                            // Size:7
    UNIT_FIELD_AURAFLAGS                       = 0x62 + OBJECT_END,
    ...
    UNIT_TRAINING_POINTS                       = 0x9D + OBJECT_END,
                                                            // Size:1
    UNIT_FIELD_STAT0                           = 0x9E + OBJECT_END,
                                                            // Size:1
    UNIT_FIELD_STAT1                           = 0x9F + OBJECT_END,
                                                            // Size:1
    UNIT_FIELD_STAT2                           = 0xA0 + OBJECT_END,
                                                            // Size:1
    UNIT_FIELD_STAT3                           = 0xA1 + OBJECT_END,
                                                            // Size:1
    UNIT_FIELD_STAT4                           = 0xA2 + OBJECT_END,
                                                            // Size:1
    ...
    PLAYER_FIELD_COMBO_TARGET                  = 0x274 + UNIT_END,
                                                            // Size:2
    PLAYER_FIELD_KNOWN_TITLES                  = 0x276 + UNIT_END,
                                                            // Size:1
    ...
    PLAYER_SPELL_CRIT_PERCENTAGE1              = 0x404 + UNIT_END,
                                                            // custom
    PLAYER_HOLY_SPELL_CRIT_PERCENTAGE          = 0x405 + UNIT_END,
                                                            // custom
    PLAYER_FIRE_SPELL_CRIT_PERCENTAGE          = 0x406 + UNIT_END,
                                                            // custom
    PLAYER_NATURE_SPELL_CRIT_PERCENTAGE        = 0x407 + UNIT_END,
                                                            // custom
    PLAYER_FROST_SPELL_CRIT_PERCENTAGE         = 0x408 + UNIT_END,
                                                            // custom
    PLAYER_SHADOW_SPELL_CRIT_PERCENTAGE        = 0x409 + UNIT_END,
                                                            // custom
    PLAYER_ARCANE_SPELL_CRIT_PERCENTAGE        = 0x40A + UNIT_END,
                                                            // Size:64
    ...
    PLAYER_FIELD_BUYBACK_TIMESTAMP_LAST        = 0x47A + UNIT_END,
                                                            // Size:1   // ((uint16)kills_today<<16) | (uint16)kills_yesterday)
    PLAYER_FIELD_KILLS                         = 0x480 + UNIT_END,
                                                            // Size:1
    PLAYER_FIELD_HONOR_TODAY                   = 0x481 + UNIT_END,
                                                            // Size:1
    PLAYER_FIELD_HONOR_YESTERDAY               = 0x482 + UNIT_END,
                                                            // Size:1
    PLAYER_FIELD_KILLS_LIFETIME                = 0x483 + UNIT_END,
                                                            // Size:1
    PLAYER_FIELD_BYTES2                        = 0x484 + UNIT_END,
                                                            // Size:1
    PLAYER_FIELD_WATCHED_FACTION_INDEX         = 0x485 + UNIT_END,
                                                            // Size:23
    PLAYER_FIELD_COMBAT_RATING_1               = 0x486 + UNIT_END,
                                                            // custom
    PLAYER_FIELD_ALL_WEAPONS_SKILL_RATING      = 0x486 + UNIT_END,
                                                            // custom
    PLAYER_FIELD_DEFENCE_RATING                = 0x487 + UNIT_END,
                                                            // custom
    PLAYER_FIELD_DODGE_RATING                  = 0x488 + UNIT_END,
                                                            // custom
    PLAYER_FIELD_PARRY_RATING                  = 0x489 + UNIT_END,
                                                            // custom
    PLAYER_FIELD_BLOCK_RATING                  = 0x48A + UNIT_END,
                                                            // custom
    PLAYER_FIELD_MELEE_HIT_RATING              = 0x48B + UNIT_END,
                                                            // custom
    PLAYER_FIELD_RANGED_HIT_RATING             = 0x48C + UNIT_END,
                                                            // custom
    PLAYER_FIELD_SPELL_HIT_RATING              = 0x48D + UNIT_END,
                                                            // custom
    PLAYER_FIELD_MELEE_CRIT_RATING             = 0x48E + UNIT_END,
                                                            // custom
    PLAYER_FIELD_RANGED_CRIT_RATING            = 0x48F + UNIT_END,
                                                            // custom
    PLAYER_FIELD_SPELL_CRIT_RATING             = 0x490 + UNIT_END,
                                                            // unsure, was PLAYER_FIELD_UNK1_RATING
    PLAYER_FIELD_HIT_RATING                    = 0x491 + UNIT_END,
                                                            // unsure, was PLAYER_FIELD_UNK2_RATING
    PLAYER_FIELD_CRIT_RATING                   = 0x492 + UNIT_END,
                                                            // custom
    PLAYER_FIELD_UNK3_RATING                   = 0x493 + UNIT_END,
                                                            // custom
    PLAYER_FIELD_UNK4_RATING                   = 0x494 + UNIT_END,
                                                            // custom
    PLAYER_FIELD_UNK5_RATING                   = 0x495 + UNIT_END,
                                                            // custom
    PLAYER_FIELD_RESILIENCE_RATING             = 0x496 + UNIT_END,
                                                            // custom
    PLAYER_FIELD_MELEE_HASTE_RATING            = 0x497 + UNIT_END,
                                                            // custom
    PLAYER_FIELD_RANGED_HASTE_RATING           = 0x498 + UNIT_END,
                                                            // custom
    PLAYER_FIELD_SPELL_HASTE_RATING            = 0x499 + UNIT_END,
                                                            // custom
    PLAYER_FIELD_MELEE_WEAPON_SKILL_RATING     = 0x49A + UNIT_END,
                                                            // custom
    PLAYER_FIELD_OFFHAND_WEAPON_SKILL_RATING   = 0x49B + UNIT_END,
                                                            // custom
    PLAYER_FIELD_RANGED_WEAPON_SKILL_RATING    = 0x49C + UNIT_END,
                                                            // Size:9
    PLAYER_FIELD_ARENA_TEAM_INFO_1_1           = 0x49D + UNIT_END,
                                                            // custom
    PLAYER_FIELD_ARENA_TEAM_ID_2v2             = 0x49D + UNIT_END,
                                                            // custom
    PLAYER_FIELD_ARENA_TEAM_ID_3v3             = 0x4A0 + UNIT_END,
                                                            // custom
    PLAYER_FIELD_ARENA_TEAM_ID_5v5             = 0x4A3 + UNIT_END,
                                                            // Size:1
    PLAYER_FIELD_HONOR_CURRENCY                = 0x4A6 + UNIT_END,
                                                            // Size:1
    PLAYER_FIELD_ARENA_CURRENCY                = 0x4A7 + UNIT_END,
                                                            // Size:1
    PLAYER_FIELD_MOD_MANA_REGEN                = 0x4A8 + UNIT_END,
                                                            // Size:1
    PLAYER_FIELD_MOD_MANA_REGEN_INTERRUPT      = 0x4A9 + UNIT_END,
                                                            // Size:1
    PLAYER_FIELD_MAX_LEVEL                     = 0x4AA + UNIT_END,
                                                            // Size:1
    PLAYER_FIELD_PADDING                       = 0x4AB + UNIT_END,
